...
namespace HelpDesk.ApiGateway.ArchitectureTests
{
    public class DependencyTests
    {
        ...
        private const string ApiNamespace = nameof(ApiGateway);
        ...
        private const string ApiControllersNamespace = $"{nameof(ApiGateway)}.Controllers";
        ...
        public void Entities_Must_DerivedFromEntity()
        {
            ...
            var testResult = Types.InAssembly(assembly)
                ...
                .Should()
                .Inherit(typeof(Core.Domain.Primitives.Entity<>))
                .GetResult();
        ...
        public void Controllers_Must_InheritFromApiController()
        {
            ...
            var testResult = Types.InAssembly(assembly)
                ...
                .ResideInNamespace(ApiControllersNamespace)
                .Should()
                .Inherit(typeof(ApiGateway.Infrastructure.ApiController))
                .GetResult();
        ...
        {
            // Arrange
            var assembly = typeof(ApiGateway.AssemblyReference).Assembly;
