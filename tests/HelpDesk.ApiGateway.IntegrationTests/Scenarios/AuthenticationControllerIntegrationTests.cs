...
using HelpDesk.ApiGateway.Controllers;
using HelpDesk.ApiGateway.IntegrationTests.Fixtures;
...
namespace HelpDesk.ApiGateway.IntegrationTests.Scenarios
{
    ...
    public sealed class AuthenticationControllerIntegrationTests : IAsyncLifetime
    {
        ...
        public async Task Login_ShouldReturnTokenResponse_WhenValidCredentials()
        {
            ...
            await _userFixture.SetUserFixtureAsync(name: "John", surname: "Doe", email: loginRequest.Email, password: loginRequest.Password, role: UserRoles.General);
        ...
        public async Task Create_ShouldReturnTokenResponse_WhenValidCredentials()
        {
            ...
            await _userFixture.SetUserRoleFixtureAsync();
        ...
        public async Task Create_ShouldReturnBadRequest_WhenDuplicatedUser()
        {
            ...
            await _userFixture.SetUserFixtureAsync(registerRequest.Name, registerRequest.Surname, registerRequest.Email, registerRequest.Password);
